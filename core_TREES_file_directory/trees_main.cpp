...
//[sean] commenting out these two lines below
  ...
  cin >> dfile;
//[sean] assigning text to string 'dfile'       "clim_whole_summer.txt"  "yu_clim.txt"  "fully_irrigated.txt"
//	strcpy(dfile, "clim.txt");  //[sean] use "clim.txt", "mo_dry_clim.txt"
...
//[sean] commenting these two cout blocks...
...
//Plant Shoot and Root Module Parameter Read In
      	...
      	//  cin >> param_file_modules;    //[sean] among other things, gives the number of shoot and root modules
				strcpy(param_file_modules, "param_mod");  //[sean] use "param_mod"
